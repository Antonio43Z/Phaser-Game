...
export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    // this.load.image("medievalbg","assets/map/medieval/medievalbg.png");
    // this.load.image("medieval_decor","assets/map/medieval/medieval_decor.png");
    // this.load.image("medieval","assets/map/medieval/medieval.png");
  
     this.load.image("caverna_bg","assets/map/caverna/caverna_bg.png" );
     this.load.image("mainlev_build","assets/map/caverna/mainlev_build.png");
  ...
  init() {
    ...
    this._loading = this.add
      .bitmapText(this.game.canvas.width / 2, 580, "arcade", "")
      .setTint(0xffffff)
      .setAlpha(1)
      .setDepth(1001)
      .setOrigin(0.5, 1);
  ...
  loadAssets(): void {
    ...
    this.load.on("complete", () => {
      console.log("Successfully loaded the scene.");
